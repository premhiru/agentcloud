  ...
  async plan(): Promise<Awaited<ReturnType<WorkerModel["plan"]>>> {
    return {
      toolCalls: [
        ...
        { id: "call_send_email", capabilityId: "gmail.send_email", input: { to: ["maya@northstar.example"], subject: "Re: Enterprise pricing enquiry", body: "Thanks for your enquiry. We would be glad to speak this week." }, summary: "Send the prepared email response" },
